...
class ie {
    ...
    fulfilled(t, n) {
        ...
        if ((!(t instanceof Element || t instanceof Text) || t.parentNode && t.parentNode !== r) && (t = te(t, !1, r.firstChild && r.firstChild.classList && r.firstChild.classList.contains("observablehq--expanded"), n)).classList.add("observablehq--inspect"), r.classList.remove("observablehq--running", "observablehq--error"), r.firstChild !== t)
            if (r.firstChild) {
    ...
    rejected(t, n) {
        ...
        o.className = "observablehq--inspect", n && o.appendChild(r(n)), o.appendChild(document.createTextNode((t + "").replace(re, ""))), i.appendChild(o), e(i, "error", {
            error: t
        })
    }
}
...
var ue = {
    ...
    element: function(e, t) {
        ...
        if (t)
            for (var s in t) i = (r = s).indexOf(":"), n = t[s], i >= 0 && "xmlns" !== (r = s.slice(0, i)) && (s = s.slice(i + 1)), se.hasOwnProperty(r) ? o.setAttributeNS(se[r], s, n) : o.setAttribute(s, n);
        return o
    },
    input: function(e) {
...
we._inside = /(?:\[[^\]]*\]|\\[\[\]]|[^\[\]]|\](?=[^\[]*\]))*/, we._href = /\s*<?([\s\S]*?)>?(?:\s+['"]([\s\S]*?)['"])?\s*/, we.link = Ee(we.link)("inside", we._inside)("href", we._href)(), we.reflink = Ee(we.reflink)("inside", we._inside)(), we.normal = qe({}, we), we.pedantic = qe({}, we.normal, {
    ...
    for (var t, n, r, i, o = ""; e;)
        ...
        else if (i = this.rules.autolink.exec(e)) e = e.substring(i[0].length), "@" === i[2] ? (n = Ce(":" === i[1].charAt(6) ? this.mangle(i[1].substring(7)) : this.mangle(i[1])), r = this.mangle("mailto:") + n) : r = n = Ce(i[1]), o += this.renderer.link(r, null, n);
    else if (this.inLink || !(i = this.rules.url.exec(e))) {
        if (i = this.rules.tag.exec(e)) !this.inLink && /^<a /i.test(i[0]) ? this.inLink = !0 : this.inLink && /^<\/a>/i.test(i[0]) && (this.inLink = !1), e = e.substring(i[0].length), o += this.options.sanitize ? this.options.sanitizer ? this.options.sanitizer(i[0]) : Ce(i[0]) : i[0];
        ...
        else if (i = this.rules.code.exec(e)) e = e.substring(i[0].length), o += this.renderer.codespan(Ce(i[2].trim(), !0));
        ...
        else if (i = this.rules.text.exec(e)) e = e.substring(i[0].length), o += this.renderer.text(Ce(this.smartypants(i[0])));
        else if (e) throw new Error("Infinite loop on byte: " + e.charCodeAt(0))
...
function Pe(e, t, n) {
    if (n || "function" == typeof t) {
        n || (n = t, t = null);
        var r, i, o = (t = qe({}, Pe.defaults, t || {})).highlight,
            s = 0;
        try {
            r = _e.lex(e, t)
        } catch (e) {
...
const Qe = Ze(async function(e, t) {
    ...
    const r = await Xe(n);
    return `${We}${r.name}@${r.version}/${n.path||function(e){for(const t of Ye){const n=e[t];if("string"==typeof n)return Ke.test(n)?n:`${n}.js`}}(r)||"index.js"}`
});
...
function et(e) {
    const t = {};
    for (const n of e)
        for (const e in n) He.call(n, e) && (null == n[e] ? Object.defineProperty(t, e, {
            get: tt(n, e)
        }) : t[e] = n[e]);
    return t
}
...
function $t(e, t, n) {
    ...
    if (this._inputs.forEach(Ct, this), t.forEach(kt, this), this._inputs = t, this._definition = n, this._value = void 0, n === bt ? i._variables.delete(this) : i._variables.add(this), e == this._name && r.get(e) === this) this._outputs.forEach(i._updates.add, i._updates);
    else {
        var o, s;
        if (this._name)
...
Object.defineProperties(xt.prototype, {
    ...
    _resolve: {
        value: function(e) {
            ...
            if (!n)
                if (n = new xt(_t, this), this._runtime._builtin._scope.has(e)) n.import(e, this._runtime._builtin);
...
function Dt(e) {
    ...
    var t = e._value,
        n = ++e._version,
        r = null,
        i = e._promise = Promise.all(e._inputs.map(Ut)).then(function(i) {
            if (e._version === n) {
...
export {
    ie as Inspector, ct as Library, Mt as Runtime, dt as RuntimeError
};